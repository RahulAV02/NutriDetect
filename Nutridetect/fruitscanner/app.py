...
model_path = "C:/Users/rahul/Desktop/fruitscanner/fruitmodel-1.h5"
...
def evaluate_rotten_vs_fresh(image_path):
    try:
        ...
        if prediction < 0.35:  # Fresh category
            ...
            freshness = f"{freshness_percentage}% Fresh - (It is Fresh)"
        elif 0.35 <= prediction < 0.65:  # Medium Fresh category
            freshness_percentage = random.randint(45, 70)
            freshness = f"{freshness_percentage}% Fresh - (It is Medium Fresh)"
        else:  # Rotten category
            freshness_percentage = random.randint(5, 45)
            freshness = f"{freshness_percentage}% Fresh - (It is Rotten)"
